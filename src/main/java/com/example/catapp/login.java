                    ...
                    firebaseAuth.createUserWithEmailAndPassword(emailID, paswd).addOnCompleteListener(login.this, new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            ...
                            if (!task.isSuccessful()) {
                                ...
                                uid=user.getUid();
                                databaseReference.child("Users").child(uid).child("money").setValue(Cat.getMoney());
                                ...
                                databaseReference.child("Users").child(uid).child("happy").setValue(Cat.getHappy());
                                databaseReference.child("Users").child(uid).child("time").setValue(Cat.getTime());
